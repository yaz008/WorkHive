...
@router.add(
    name=FSAState.OwnerPointCharge,
    pipeline=FSAPipeline.Owner,
    transitions={
        FSASymbol.Back: FSAState.OwnerPointPayload,
        FSASymbol.InputData: FSAState.OwnerPointCharge,
        FSASymbol.Next: FSAState.OwnerPointChargePerOne,
    },
    accepts_types=('text',),
)
